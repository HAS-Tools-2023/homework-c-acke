# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 15:53:10 2023
...
# TODO: Your code here
datasets = xr.open_mfdataset(downloaded_files)
...
#TODO: Your code here
datasets = datasets.drop_vars('crs')
...
# from the full `ds`
#TODO: Your code here
sub_datasets = datasets.isel(lat=slice(0,30), lon=slice(20,40))
...
# TODO: Your code here
spatial_mean_ds = sub_datasets.mean(dim=['lat', 'lon'])
...
# 
# TODO: Your code here
corr_matrix = np.corrcoef(spatial_mean_ds['potential_evapotranspiration'], 
...
# TODO: Your code here
correlation = None
corr_coarsen = xr.corr(coarse_ds['mean_vapor_pressure_deficit'], 
