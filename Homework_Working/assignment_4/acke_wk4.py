...
# %%
# Starter Code
# Count the number of values with flow equal to something, in the month of September
...
plt.hist(pick_data[:], bins = mybins)
plt.title('Streamflow Occurrences in Sept. Over 100 cfs')
plt.xlabel('Flow [cfs]')
plt.ylabel('Count')
